...
const navData = {
  ...
  socials: [
    ...
    {
      href: "https://www.linkedin.com/in/diksh-sawaliya-6111381a7/",
      label: "LinkedIn",
    },
  ],
};
...
const skillsData = {
  ...
  groups: [
    {
      category: "Languages",
      tags: ["Kotlin", "Java", "TypeScript", "HTML", "CSS", "XML"],
    },
    {
      category: "Android",
      tags: [
    ...
    },
    {
      ...
      tags: ["React Native", "Redux", "Zustand", "Reanimated", "Axios"],
    },
    {
      category: "SDK & Infrastructure",
      tags: [
        "SDK Dev",
        "Voice Recognition",
        "Barcode Scanner",
    ...
    {
      category: "AR / XR",
      tags: ["Unity", "Unreal Engine", "Jio SDK", "Meta VR"],
    },
  ],
};
...
const journeyData = {
  ...
  intro:
    "Most engineers pick a lane and stay there. I've deliberately jumped across worlds — from game engines to spatial computing to native Android to cross-platform SDKs. Each leap wasn't a detour; it was compound interest on curiosity.",
  eras: [
    {
      className: "e-game",
      year: "2021 – 2022",
...
const experienceData = {
  ...
  items: [
    ...
    },
    {
      ...
      loc: "Mumbai, India",
      bullets: [
        "Developed a zombie survival AR game for Jio Glasses using Unity + Jio SDK, delivering immersive gameplay optimised for constrained XR hardware",
      ],
    },
    {
      company: "CSKAA",
      ...
      loc: "Noida, India",
      bullets: [
        "Built a Meta University virtual education environment and a 3D Car Visualizer with realistic rendering — shipped to internal stakeholders on schedule",
      ],
    },
    {
      company: "Huawei",
      ...
      bullets: [
        "Developed and published GettingRipped fitness app on Huawei AppGallery end-to-end using Huawei HMS Core, gaining hands-on deployment experience",
      ],
    },
  ],
};
...
const contactData = {
  ...
  details: [
    {
      href: "mailto:diksh101sawaliya@gmail.com",
      text: "diksh101sawaliya@gmail.com",
      icon: "✉",
    },
